...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/", "/member/**", "/search/**", "/search-success/**", "/search-fail/**", "/item-detail/**", "/게시판").permitAll()  // 해당 경로에 대한 모든 요청을 허용
                ...
                .logoutSuccessHandler((request, response, authentication) -> response.sendRedirect("/member/login"))  // 소셜 로그아웃 성공 후 처리 및 리다이렉트
